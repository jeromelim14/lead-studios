  ...
  return (
    <>
      <Comp
        ...
        {...props}
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-sm border-gray-300 bg-white/5 backdrop-blur-sm
            shadow-[0_4px_20px_rgba(0,0,0,0.15),inset_0_1px_0_rgba(255,255,255,0.2),inset_0_-1px_0_rgba(0,0,0,0.1)] 
        transition-all duration-300 hover:shadow-[0_6px_30px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.3)]" 
        style={{borderWidth}} />
